// Ported verbatim from the ArrowRef console
// (infrastructure/query-cache/repo/ui/src/components/StatusBadge.tsx) — the
// canonical state pill for this design system.
